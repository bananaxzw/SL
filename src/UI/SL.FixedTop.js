...
sl.create("sl.ui", function () {
    ...
    this.fixedtop = sl.Class({
        init: function (elem, options) {
            this.fixed = false;
            var $elem = slChain(elem), initialPostion = $elem.css("position"), initialTop = $elem.css("top"), initialleft = $elem.css("left");
        ...
        set: function () {
            ...
            this.fixed = true;
            var $elem = slChain(this.elem), options = $elem.data("sl.ui.fixedtop").options, top = options.top || 0, left = options.left || 0
        ...
        reset: function () {
            this.fixed = false;
            var $elem = slChain(this.elem), options = $elem.data("sl.ui.fixedtop");
